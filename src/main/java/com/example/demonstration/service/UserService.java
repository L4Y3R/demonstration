...
public class UserService {
    ...
    public Optional<UserDTO> deleteUser(String id) {
        ...
        if (existingUserOptional.isPresent()) {
            ...
            UserDTO deletedDeviceDTO = new UserDTO();
            deletedUserDTO.setUserName(existingUserOptional.get().getUserName());
            deletedUserDTO.setUserType(existingUserOptional.get().getUserType());
            deletedUserDTO.setStatus(existingUserOptional.get().getStatus());
